...
//   const [uploaded, setUploaded] = useState(false); // ✅ Show dashboard button
...
//     try {
//       const res = await uploadCSV(formData); // Expected: { msg, rows, kpis }
...
//       setUploaded(true); // ✅ Enable dashboard button
...
//   return (
//     <div className="space-y-6 bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-xl w-full max-w-lg mx-auto">
...
//   <button
//     onClick={() => {
//       const isLoggedIn = localStorage.getItem("isLoggedIn"); // or "token" / "user"
//       if (isLoggedIn) {
//         navigate("/dashboard");
//       } else {
...
//       }
//     }}
//     className="w-full mt-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-300"
//   >
//     📊 Go to Dashboard
//   </button>
// )}
